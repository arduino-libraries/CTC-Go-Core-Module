...
int counter = 0;        // to count the mistake letters
int mistakes = 0;       // to show the mistakes
int success = 0;        // to count the success letters
int chances = 3;        // to select when the game is over
